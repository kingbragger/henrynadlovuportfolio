  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-8xl text-ember">404</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Henry Ndlovu, Software Engineer and Full Stack Developer" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Henry Ndlovu, Software Engineer" },
      {
        ...
        content:
          "Full stack web, AI, cloud and data. 50+ shipped projects across logistics, fintech, healthtech and more.",
      },
